...
<form action="index.php?page=updateUsers" method="post">
    <div class="mb-3">
        <input type="hidden" class="form-control" id="exampleInputEmail1" name="contactID" value="<?php echo $c['userID']; ?>" disabled>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="level" class="form-control" id="exampleInputEmail1" name="email" value="<?php echo $c["email"];?>" placeholder="Ketik Email..">
    </div>
      <div class="mb-3">
