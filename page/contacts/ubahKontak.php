...
<form action="index.php?page=updateKontak" method="post">
    <div class="mb-3">
        <input type="hidden" class="form-control" id="exampleInputEmail1" name="contactID" value="<?php echo $c['contactID']; ?>">
    </div>
    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Nama Lengkap</label>
        <input type="text" class="form-control" id="exampleInputEmail1" name="nameC" value="<?php echo $c['nameC'];?>" placeholder="Ketik Nama..">
    </div>
    <div class="mb-3">
